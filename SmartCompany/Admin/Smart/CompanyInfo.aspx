<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Smart/ManageSite.master" AutoEventWireup="true" CodeBehind="CompanyInfo.aspx.cs" Inherits="SmartCompany.Admin.Smart.CompanyInfo" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="AjaxControlToolkit" %>

<%@ Register src="Components/Home/CompanyInfo.ascx" tagname="CompanyInfo" tagprefix="MukhtarWebUIControl" %>
...
<asp:UpdatePanel ID="UpdatePanelSmartSys" runat="server">
    <ContentTemplate>
        <MukhtarWebUIControl:CompanyInfo ID="mwcCompanyInfo" runat="server" />    
    </ContentTemplate>
</asp:UpdatePanel>
