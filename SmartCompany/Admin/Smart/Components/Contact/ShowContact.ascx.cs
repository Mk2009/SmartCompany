...
{
    public partial class ShowContact : System.Web.UI.UserControl
    {
        ...
        protected int ContactUsID
        {
            get
            {
                object obj = this.ViewState["ContactUsID"];
                if (obj == null)
            ...
            set
            {
                this.ViewState["ContactUsID"] = value;
            }
        }
        ...
        protected void lnkBtnDetails_Click(object sender, EventArgs e)
        {
            ...
            DetailMessage mwcDetail = (DetailMessage)Parent.FindControl("mwcDetail");
            mwcDetail.ContactID = Convert.ToInt32(lnkBtnDetails.CommandArgument);
        ...
        #region 2. Search Keywork [SearchContacts]
        /// <summary>
        ...
        {
            var contact = (from c in smartDb.ContactUs where c.Id == this.ContactUsID select c).First();

            try
            {
                smartDb.ContactUs.DeleteOnSubmit(contact);
