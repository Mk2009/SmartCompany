<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DetailCategory.ascx.cs" Inherits="SmartCompany.Admin.Smart.Components.Category.DetailCategory" %>
...
<div class="box">
	...
	<div class="box-head">
		...
		<div class="search">
            <asp:ImageButton ID="imgBtnEditDet" runat="server" OnClick="imgBtnEditDet_Click" 
                CssClass="nav_ImagePath edit_en" 
                ImageUrl="~/App_Themes/Admin/Images/spacer.gif" ToolTip="Edit" 
                meta:resourcekey="imgBtnEditDetResource1" />
            <asp:ImageButton ID="imgBtnPrint" runat="server" CssClass="nav_ImagePath print" 
