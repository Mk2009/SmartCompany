<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EntryNews.ascx.cs" Inherits="SmartCompany.Admin.Smart.Components.News.EntryNews" %>
			...
			<p>
                ...
                <p>
                    <asp:Label ID="lbActive" runat="server" CssClass="title" 
                        meta:resourcekey="lbActiveResource1" Text="Show" />
