<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShowNews.ascx.cs" Inherits="SmartCompany.Admin.Smart.Components.News.ShowNews" %>
...
<!-- Box Head -->
<div class="box-head">
	<h2 class="title"><asp:Label ID="lbBoxTitle" runat="server" Text="Activities Management" meta:resourcekey="lbBoxTitleResource1" /></h2>
	<div class="search">
