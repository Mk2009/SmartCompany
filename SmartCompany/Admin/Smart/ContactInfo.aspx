<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Smart/ManageSite.master" AutoEventWireup="true" CodeBehind="ContactInfo.aspx.cs" Inherits="SmartCompany.Admin.Smart.ContactInfo" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="AjaxControlToolkit" %>

<%@ Register src="Components/Home/ContactInfo.ascx" tagname="ContactInfo" tagprefix="MukhtarWebUIControl" %>
...
<asp:UpdatePanel ID="UpdatePanelSmartSys" runat="server">
    <ContentTemplate>
        <MukhtarWebUIControl:ContactInfo ID="mwcContactInfo" runat="server" />        
    </ContentTemplate>
</asp:UpdatePanel>
